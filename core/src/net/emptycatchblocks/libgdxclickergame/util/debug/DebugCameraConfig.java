package net.emptycatchblocks.libgdxclickergame.util.debug;
...
public class DebugCameraConfig {
    ...
    // names/keys in key-value map or names of our values inside of json files
